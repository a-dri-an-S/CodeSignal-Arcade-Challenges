...
// if experience + reward is greater than or equal to threshold, return true, else false 
const reachNextLevel = (experience, threshold, reward) => (experience + reward) >= threshold ? true : false;
